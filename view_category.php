...
<body>
	<div class="header" style="height:100px;width:100%;background-color: #0094ff;margin:0;">
		...
		<div class="section">
			...
			<br>
			<input type="submit" value="ADD SUB-CATEGORY" class="add_category">
			</div><br>
			...
			<table border="1" class="bordered">
				...
				<tr>
					...
					<td><a href="view_sub_category" >VIEW</a></td>
					<td><a href="update_sub_category" >UPDATE</a></td>
					<td><a href="delete_sub_category" >DELETE</a></td>
				</tr>		
